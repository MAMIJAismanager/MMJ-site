...
const body = {
  ...
  workflowName: process.env.GITHUB_WORKFLOW || 'MMJ CMS Portfolio Deploy',
  ...
  deployment: state === 'succeeded' ? {
    ...
    deploymentId: process.env.MMJ_DEPLOYMENT_ID || `github-${process.env.GITHUB_RUN_ID}-${process.env.GITHUB_RUN_ATTEMPT}`,
