...
<template>
  <div
    ...
    :data-mm-layout-guidance-single-row="layoutReceipt ? String(layoutReceipt.measurement.guidanceSingleRow) : undefined"
    :data-mm-layout-terms-single-row="layoutReceipt ? String(layoutReceipt.measurement.termsSingleRow) : undefined"
